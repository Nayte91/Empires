...
#[Route('/game/{slug}/operator/calamities', name: 'app_operator_calamities', requirements: ['slug' => '[a-z0-9-]+'], methods: ['GET'])]
final class CalamitiesController extends AbstractController
{
