...
final class Version20260726_player extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add an append-only credit ledger to the player, recording per-turn scoped credit grants and losses';
    }

    public function up(Schema $schema): void
    {
        $this->addSql("ALTER TABLE player ADD COLUMN credit_ledger CLOB DEFAULT '[]' NOT NULL");
    }

    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, slug, empire, advances, cities, census, treasury, ships, cards, ast_position, name, game_id FROM player');
        ...
        $this->addSql('INSERT INTO player (id, slug, empire, advances, cities, census, treasury, ships, cards, ast_position, name, game_id) SELECT id, slug, empire, advances, cities, census, treasury, ships, cards, ast_position, name, game_id FROM __temp__player');
