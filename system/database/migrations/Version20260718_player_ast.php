...
final class Version20260718_player_ast extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add AST (Archaeological Succession Table) position to player';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE player ADD COLUMN ast_position SMALLINT DEFAULT 0 NOT NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, slug, empire, advances, cities, census, treasury, name, game_id FROM player');
        ...
        $this->addSql('INSERT INTO player (id, slug, empire, advances, cities, census, treasury, name, game_id) SELECT id, slug, empire, advances, cities, census, treasury, name, game_id FROM __temp__player');
