...
final class Version20260719_init extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id BLOB NOT NULL, status VARCHAR(255) NOT NULL, lines CLOB NOT NULL, total INTEGER DEFAULT NULL, validated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, turn SMALLINT NOT NULL, player_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_E52FFDEE99E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
